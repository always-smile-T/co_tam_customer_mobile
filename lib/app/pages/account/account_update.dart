      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text('Update Information', style: TextStyle(fontSize: 18, color: Colors.black54),textAlign:  TextAlign.center)
                      ],
                    ),
                  )
                ],
            ...
            FieldUpdate(title: "Name", conroller: _nameController,hintText: name.toString(),),
            FieldUpdate(title: "Birthday", conroller: _dateBirthController,hintText: dateOfBirth.toString(),),
            FieldUpdate(title: "Phone", conroller: _phoneNController,hintText: phone.toString(),),
